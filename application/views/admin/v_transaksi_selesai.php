<div class="col-xl-12 col-md-6 mb-4">
	<div class="card border-left-success shadow h-100 py-2">
		<div class="card-body">
			...
			</div> <?php foreach($transaksi as $t){ ?>
			<form action="<?php echo base_url().'admin/transaksi_selesai_act' ?>" method="post">
				...
				<div class="form-group">
					...
					<select class="form-control" name="kostumer" disabled>
						...
						<option <?php if($t->transaksi_kostumer == $k->kostumer_id){echo "selected='selected'";} ?>
							value="<?php echo $k->kostumer_id; ?>"><?php echo $k->kostumer_nama; ?>
						</option> <?php } ?>
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select class="form-control" name="mobil" disabled>
						...
						<option <?php if($t->transaksi_mobil == $m->mobil_id){echo "selected='selected'";} ?>
							value="<?php echo $m->mobil_id; ?>"><?php echo $m->mobil_merk; ?></option>
						<?php } ?>
					</select>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="denda" value="<?php echo $t->transaksi_denda ?>"
						disabled>
				</div>
				<div class="form-group">
