		...
		<div class="card-body">
			...
			<div class="btn-group">
				<a class="btn btn-warning btn-sm"
					href="<?php echo base_url().'admin/laporan_pdf/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>">
					<i class="fas fa-file-pdf"></i> Cetak PDF
				</a>
				<a class="btn btn-default btn-sm"
					href="<?php echo base_url().'admin/laporan_print/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>" target="blank">
			...
			<div class="table-responsive">
				<table border="1" class="table table-striped table-hover table-bordered" id="dataTable">
					<thead>
						<tr>
							<th>No</th>
							<th>Tanggal</th>
					...
					<tbody> <?php $no = 1; foreach($laporan as $l){?>
						<tr>
							<td><?php echo $no++; ?></td>
							...
							<td> <?php if($l->transaksi_status == "1"){ echo "Selesai"; }else{ echo "-"; } ?> </td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
